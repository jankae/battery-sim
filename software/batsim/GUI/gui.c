...
//	container_attach(c, b6, COORDS(20, 250));
	...
	container_t *c2 = container_new(window_GetAvailableArea(w));
//	container_attach(c, b1, COORDS(20, 0));
//	container_attach(c, b2, COORDS(20, 50));
//	container_attach(c, b3, COORDS(20, 100));
	container_attach(c2, b4, COORDS(20, 0));
	container_attach(c2, b5, COORDS(20, 50));
	container_attach(c2, b6, COORDS(20, 100));
	window_SetMainWidget(w, c2);
	display_Clear();
